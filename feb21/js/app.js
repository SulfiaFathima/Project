...
var text = {
    "mobiles": [
        { "id": 1, "category": "mobile", "img": "./images/phone/phone1.jpg", "title": "Samsung Galaxy M33 5G (Mystique Green, 6GB, 128GB Storage) | 6000mAh Battery | Upto 12GB RAM with RAM Plus | Travel Adapter to be Purchased Separately", "desc": "Get it by, Saturday", "price": 20000, "cart": "Add To Cart", "quantity": 1,"totalAmt":20000 },
        { "id": 2, "category": "mobile", "img": "./images/phone/phone2.jpg", "title": "Samsung Galaxy M04 Light Green, 4GB RAM, 128GB Storage | Upto 8GB RAM with RAM Plus | MediaTek Helio P35 | 5000 mAh Battery", "desc": "Get it by,Wednesday", "price": 15000, "cart": "Add To Cart", "quantity": 1 ,"totalAmt":15000 },
        { "id": 3, "category": "mobile", "img": "./images/phone/phone3.jpg", "title": "Redmi 10A Sport (Sea Blue, 6GB RAM, 128GB Storage) | 2 Ghz Octa Cor Helio G25 | 5000 mAh Battery | Finger Print Sensor | Upto 8GB RAM with RAM Booster", "desc": "Get it by,Monday", "price": 12700, "cart": "Add To Cart", "quantity": 1,"totalAmt":12700 },
        { "id": 4, "category": "mobile", "img": "./images/phone/phone4.jpg", "title": "Redmi A1 (Light Blue, 2GB RAM, 32GB Storage) | Segment Best AI Dual Cam | 5000mAh Battery | Leather Texture Design | Android 12", "desc": "Get it by,Saturday", "price": 11300, "cart": "Add To Cart", "quantity": 1,"totalAmt":11300 },
        { "id": 5, "category": "mobile", "img": "./images/phone/phone5.jpg", "title": "Tecno Spark 9 (Sky Mirror, 6GB RAM,128GB Storage) | 11GB Expandable RAM | Helio G37 Gaming Processo", "desc": "Get it by,Monday", "price": 50000, "cart": "Add To Cart", "quantity": 1,"totalAmt":50000 },
        { "id": 6, "category": "mobile", "img": "./images/phone/phone6.jpg", "title": "Redmi Note 11 (Space Black, 6GB RAM, 64GB Storage) | 90Hz FHD+ AMOLED Display | Qualcomm® Snapdragon™ 680-6nm | 33W Charger Included", "desc": "Get it by, Tuesday", "price": 45000, "cart": "Add To Cart", "quantity": 1 ,"totalAmt":45000},
        { "id": 7, "category": "mobile", "img": "./images/phone/phone7.jpg", "title": "Redmi A1 (Black, 2GB RAM, 32GB Storage) | Segment Best AI Dual Cam | 5000mAh Battery | Leather Texture Design | Android 12", "desc": "Get it by,Thursday", "price": 39999, "cart": "Add To Cart", "quantity": 1,"totalAmt":39999 },
        { "id": 8, "category": "mobile", "img": "./images/phone/phone8.jpg", "title": "Redmi 11 Prime 5G (Thunder Black, 4GB RAM, 64GB Storage) | Prime Design | MTK Dimensity 700 | 50 MP Dual Cam | 5000mAh | 7 Band 5G", "desc": "Get it by, Monday", "price": 41999, "cart": "Add To Cart", "quantity": 1 ,"totalAmt":41999},
        { "id": 9, "category": "mobile", "img": "./images/phone/phone1.jpg", "title": " Samsung Galaxy M13 (Stardust Brown, 4GB, 64GB Storage) | 6000mAh Battery | Upto 8GB RAM with RAM Plus", "desc": "Get it by, Saturday", "price": 11999, "cart": "Add To Cart", "quantity": 1,"totalAmt":11999 },
        { "id": 10, "category": "mobile", "img": "./images/phone/phone2.jpg", "title": "Redmi 11 Prime 5G (Thunder Black, 4GB RAM, 64GB Storage) | Prime Design | MTK Dimensity 700 | 50 MP Dual Cam | 5000mAh | 7 Band 5G", "desc": "Get it by, Thursday", "price": 12549, "cart": "Add To Cart", "quantity": 1,"totalAmt":12549 },
        { "id": 11, "category": "mobile", "img": "./images/phone/phone3.jpg", "title": "Redmi A1 (Black, 2GB RAM, 32GB Storage) | Segment Best AI Dual Cam | 5000mAh Battery | Leather Texture Design | Android 12", "desc": "Get it by, Friday", "price": 15699, "cart": "Add To Cart", "quantity": 1,"totalAmt":15699 },
        { "id": 12, "category": "mobile", "img": "./images/phone/phone4.jpg", "title": "Redmi Note 11 (Space Black, 6GB RAM, 64GB Storage) | 90Hz FHD+ AMOLED Display | Qualcomm® Snapdragon™ 680-6nm | 33W Charger Included", "desc": "Get it by, Sunday", "price": 100955, "cart": "Add To Cart", "quantity": 1,"totalAmt":100955 },
        { "id": 13, "category": "mobile", "img": "./images/phone/phone5.jpg", "title": "Tecno Spark 9 (Sky Mirror, 6GB RAM,128GB Storage) | 11GB Expandable RAM | Helio G37 Gaming Processo", "desc": "Get it by,Friday", "price": 99000, "cart": "Add To Cart", "quantity": 1,"totalAmt":99000 },
        { "id": 14, "category": "mobile", "img": "./images/phone/phone1.jpg", "title": "Tecno Spark 9 (Sky Mirror, 6GB RAM,128GB Storage) | 11GB Expandable RAM | Helio G37 Gaming Processo", "desc": "Get it by,Friday", "price": 99000, "cart": "Add To Cart", "quantity": 1 ,"totalAmt":99000},
        { "id": 15, "category": "mobile", "img": "./images/phone/phone6.jpg", "title": "Redmi A1 (Light Blue, 2GB RAM, 32GB Storage) | Segment Best AI Dual Cam | 5000mAh Battery | Leather Texture Design | Android 12", "desc": "Get it by,Tuesday", "price": 5999, "cart": "Add To Cart", "quantity": 1,"totalAmt":5999 }]
};
items = text.mobiles;
    ...
    if (localStorage.getItem("cartArray") === null) {
        ...
        existingData.forEach((element) => {
            ...
            if (item.id === element.id) {
                ...
                item.quantity = item.quantity + 1;
                item.totalAmt = item.quantity * item.price;
                console.log("Changed Quantity:", item.quantity);
                console.log("totalAmt:", item.totalAmt);
...
function getCartItems() {
    ...
    // getArray.quantity
    let len = getArray.length; 

    if(len === 0){
        document.getElementById("addtocart").innerHTML = 0;
...
function displayCart() {
    ...
    getCartData.sort((a,b) => a.id - b.id);
...
// Overall Total amount in cart Page
function overAllTotal(){
    let data = JSON.parse(localStorage.getItem("cartArray"));
    console.log(data.length);
    if (data != null) {
        for (const item of data) {
         totalAmount = data.reduce((accumulator, currentValue) => accumulator + currentValue.totalAmt, 0);
         console.log("overAllTotal",totalAmount); 
         //  totalCount = item.quantity;
       }
...
function cartIncrement(item) {
    addtocart(item);
    displayCart();
    // location.reload(); //deleted reload
    // countTotal(item);
}
   ...
   let deleteCheck = true;
    ...
    if (localStorage.getItem("cartArray") != null) {
        ...
        if(quanNum >= 2){
            ...
            a.totalAmt = a.quantity * a.price;
            items.splice(index, 1);
            console.log("NO",a.quantity);
            console.log("NO",a.totalAmt);
            items.push(a);
...
function countTotal(item) {
    ...
    console.log("itemCounts", itemCount);
